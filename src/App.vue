  ...
  <div id="app">
    <header>
      <div class="contentContainer">
        <div class="navigationContainer">
          <div class="logo">
            <img src="./img/Group.png" alt="logo" width=48 height=48>
          </div>
          <nav>
            <ul>
              <li><router-link to="/" class="link">Каталог</router-link></li>
              <li>Доставка</li>
              <li>Оплата</li>
              <li>Контакты</li>
              <li>О галерее</li>
    ...
    <footer>
      <div class="contentContainer">
        <div class="navigationContainer">
          <div class="logo">
            <img src="./img/Group dark.png" alt="logo" width=48 height=48>
          </div>
          <nav>
            <ul>
              <li><router-link to="/" class="link">Каталог</router-link></li>
